<template>
  <div class="saved-trips-container">
    <h2>Viajes Guardados de Torneos</h2>
      ...
      <li v-for="trip in tripStore.savedTrips" :key="trip.id">
        <div class="trip-header">
          <div class="trip-info">
            ...
            <span class="trip-date">Guardado el: {{ new Date(trip.dateCreated).toLocaleDateString() }}</span>
          </div>
...
function loadTripForEditing(tripId) {
  ...
  emit('switch-view', 'TournamentTripsView');
}
...
/* ========================================
   ...
   SavedTournamentTripsView - Tournament Purple Theme
   ======================================== */
